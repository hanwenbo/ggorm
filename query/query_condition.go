...
type Params struct {
	Page  int    `json:"_page" form:"_page" binding:"gte=1"`
	Limit int    `json:"_limit" form:"_limit" binding:"gte=1"`
...
type Conditions struct {
	Columns []Column `json:"_columns" form:"_columns" binding:"min=1"` // columns info
}
